...
if(cat1.checked ==true){  
  cardArray1=(arrayToCard(eventsFilter(pastEvents , "Food Fair")))
...
if(cat2.checked ==true){
  cardArray2=(arrayToCard(eventsFilter(pastEvents , "Museum")))
...
if(cat3.checked ==true){
  cardArray3= arrayToCard(eventsFilter(pastEvents , "Costume Party"))
...
if(cat4.checked ==true){
  cardArray4=(arrayToCard(eventsFilter(pastEvents , "Music Concert")))
...
if(cat5.checked ==true){
  cardArray5=(arrayToCard(eventsFilter(pastEvents , "Race")))
...
if(cat6.checked ==true){
  cardArray6=(arrayToCard(eventsFilter(pastEvents , "Book Exchange")))
...
if(cat7.checked ==true){
  cardArray7=(arrayToCard(eventsFilter(pastEvents , "Cinema")))
